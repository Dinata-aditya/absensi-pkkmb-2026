...
BEGIN
    ...
    -- ⚠️ TIME VALIDATION DISABLED FOR TESTING
    -- This allows scanning at any time when session is OPEN
    -- For production, uncomment and fix the time validation logic below
...
BEGIN
    ...
    RAISE NOTICE '⚠️  TIME VALIDATION DISABLED for testing';
    RAISE NOTICE '✓ Scan can be done anytime when session is OPEN';
    RAISE NOTICE '========================================';
END $$;
